                ...
                <tbody>
                    <?php foreach ($paysList as $pays): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_pays.php?id=<?= $pays->getId(); ?>" class="btn btn-warning btn-sm">Modifier</a>
                                <a href="delete_pays.php?id=<?= $pays->getId(); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce pays ?');">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
