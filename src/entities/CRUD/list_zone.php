                ...
                <tbody>
                    <?php foreach ($zonesList as $zone): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_zone.php?id=<?= $zone->getId(); ?>" class="btn btn-warning btn-sm">Modifier</a>
                                <a href="delete_zone.php?id=<?= $zone->getId(); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette zone ?');">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
