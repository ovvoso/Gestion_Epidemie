...
$pointSurveillancesList = $entityManager->getRepository(PointSurveillance::class)->findAll();
?>
                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            <?php foreach ($pointSurveillancesList as $pointSurveillance): ?>
                              <tr>
                                <td><?= htmlspecialchars($pointSurveillance->getNom_pointsuper()); ?></td>
                                <td><?= htmlspecialchars($pointSurveillance->getZone()->getNom()); ?></td>

                                <td>
                                  <a href="update_pointsurveillance.php?id=<?= $pointSurveillance->getId(); ?>" class="btn btn-warning btn-sm">Modifier</a>
