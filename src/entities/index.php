...
<html lang="en">
  <head>
	...
	<link rel="icon" href="../../Admin1/production/images/favicon.ico" type="image/ico" />
    ...
    <link href="../../Admin1/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="../../Admin1/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>Gestion épidemie</span></a>
            </div>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<ul class="nav child_menu">
									<li><a href="CRUD/add_pays.php">Ajouter</a></li>
									<li><a href="CRUD/list_pays.php">Lister</a></li>
								</ul>
								</li>
							</ul>
							<ul class="nav side-menu">
								...
								<ul class="nav child_menu">
									<li><a href="CRUD/add_zone.php">Ajouter</a></li>
									<li><a href="CRUD/list_pays.php">Lister</a></li>
								</ul>
								</li>
							</ul>
							<ul class="nav side-menu">
								...
								<ul class="nav child_menu">
									<li><a href="CRUD/add_pointsurveillance.php">Ajouter</a></li>
									<li><a href="CRUD/list_pointsurveillance.php">Lister</a></li>
								</ul>
								</li>
							</ul>
						</div>
  ...
  //..
    ...
    <!-- Chart.js -->
    <script src="../../Admin1/vendors/Chart.js/dist/Chart.min.js"></script>
    <!-- gauge.js -->
    <script src="../../Admin1/vendors/gauge.js/dist/gauge.min.js"></script>
    <!-- bootstrap-progressbar -->
    ...
    <!-- Skycons -->
    <script src="../../Admin1/vendors/skycons/skycons.js"></script>
    <!-- Flot -->
    <script src="../../Admin1/vendors/Flot/jquery.flot.js"></script>
    <script src="../../Admin1/vendors/Flot/jquery.flot.pie.js"></script>
    <script src="../../Admin1/vendors/Flot/jquery.flot.time.js"></script>
    <script src="../../Admin1/vendors/Flot/jquery.flot.stack.js"></script>
    <script src="../../Admin1/vendors/Flot/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
    <script src="../../Admin1/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="../../Admin1/vendors/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="../../Admin1/vendors/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
    <script src="../../Admin1/vendors/DateJS/build/date.js"></script>
    <!-- JQVMap -->
    <script src="../../Admin1/vendors/jqvmap/dist/jquery.vmap.js"></script>
    <script src="../../Admin1/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="../../Admin1/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
    <!-- bootstrap-daterangepicker -->
